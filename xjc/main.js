...
(function(global, factory) {
    ...
    function posFromMouse(cm, e, liberal, forRect) {
        ...
        try { x = e.clientX - space.left;
            y = e.clientY - space.top; } catch (e) { return null }
    ...
    function ensureFocus(cm) {
        if (!cm.state.focused) { cm.display.input.focus();
            onFocus(cm); }
    }
        ...
        removeInner: function removeInner(at, n) {
            ...
            for (var i = 0; i < this.children.length; ++i) {
                ...
                if (at < sz) {
                    ...
                    if (sz == rm) { this$1.children.splice(i--, 1);
                        child.parent = null; }
                    if ((n -= rm) == 0) { break }
                    at = 0;
                } else { at -= sz; }
    ...
    var commands = {
        ...
        goLineStart: function(cm) {
            return cm.extendSelectionsBy(function(range) { return lineStart(cm, range.head.line); }, { origin: "+move", bias: 1 });
        },
        goLineStartSmart: function(cm) {
            return cm.extendSelectionsBy(function(range) { return lineStartSmart(cm, range.head); }, { origin: "+move", bias: 1 });
        },
        goLineEnd: function(cm) {
            return cm.extendSelectionsBy(function(range) { return lineEnd(cm, range.head.line); }, { origin: "+move", bias: -1 });
        },
    ...
    function leftButtonStartDrag(cm, event, pos, behavior) {
        ...
        var dragEnd = operation(cm, function(e) {
            ...
            if (!moved) {
                ...
                if (webkit || ie && ie_version == 9) { setTimeout(function() { document.body.focus();
    ...
    function gutterEvent(cm, e, type, prevent) {
        ...
        if (e.touches) {
            ...
            try { mX = e.clientX;
                mY = e.clientY; } catch (e) { return false }
        }
        ...
        CodeMirror.prototype = {
            ...
            moveH: methodOp(function(dir, unit) {
                ...
                this.extendSelectionsBy(function(range$$1) {
                    if (this$1.display.shift || this$1.doc.extend || range$$1.empty()) { return findPosH(this$1.doc, range$$1.head, dir, unit, this$1.options.rtlMoveVisually) } else { return dir < 0 ? range$$1.from() : range$$1.to() }
                }, sel_move);
            }),
    ...
    function findPosH(doc, pos, dir, unit, visually) {
        ...
        function moveOnce(boundToLine) {
            ...
            if (next == null) {
                if (!boundToLine && findNextLine()) { pos = endOfLine(visually, doc.cm, lineObj, pos.line, dir); } else { return false }
            } else {
                pos = next;
            }
            return true
